...
def TakeStereo(id, frameL,frameR):
    ...
    global disparity_buffer, prev_frame_time, fps, fps_cam, paraCtl, choosePara, block_size, min_disp, max_disp, uniquenessRatio, speckleWindowSize, speckleRange, disp12MaxDiff, preFilterCap, lmbda, sigma
    ...
    with worker:
        ...
        fps = 0.999 * fps + 0.001 / (new_frame_time - prev_frame_time)
